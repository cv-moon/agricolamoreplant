  ...
  <div class="card card-primary card-outline">
    <div class="card-header">
      ...
      <div class="card-tools">
        <router-link to="/puntos-emision/agregar" class="btn btn-success">
      ...
      >
        ...
        <tbody>
          <tr
            ...
            :key="punto.id"
            :class="punto.estado == 1 ? 'table-success' : 'table-danger'"
          >
            <td>
              <router-link
                type="button"
            ...
            <td v-text="punto.codigo" align="right"></td>
            <td v-text="punto.nombre"></td>
            ...
            <td v-text="punto.sec_recibo" align="right"></td>
