  ...
  <div class="card card-primary card-outline">
    ...
    <div class="card-body">
      <form enctype="multipart/form-data" class="form-horizontal">
        ...
        <div class="row">
          <div class="col-md-7">
            <div class="form-group row">
              <label for="raz_social" class="col-sm-12 col-form-label"
                >Razón Social:
              </label>
              <div class="col-sm-12">
                <input
            ...
            <div class="form-group row">
              <label for="url" class="col-sm-12 col-form-label">Email:</label>
              <div class="col-sm-12">
                <input
                  type="url"
                  v-model="url"
            ...
            <div class="form-group row">
              <label for="direccion" class="col-sm-12 col-form-label"
                >Dirección:</label
              >
              <div class="col-sm-12">
                <input
            ...
            <div class="col-sm-10">
              ...
              <figure align="center">
                <img
                  width="200"
                  height="200"
                  :src="image ? image : '/img/cloud-upload.png'"
                  alt="Logo Empresa"
                />
              </figure>
            </div>
        ...
        <div class="form-group row">
          <div class="col-sm-4">
            <label for="cont_resolucion" class="col-sm-12 col-form-label"
              ># Cont. Especial:</label
            >
            <input
              type="number"
          ...
          <div class="col-sm-4">
            <label for="obli_contabilidad" class="col-sm-12 col-form-label"
              >Obligado Contabilidad:</label
            >
            <select v-model="obli_contabilidad" class="form-control">
          ...
          <div class="col-sm-4">
            <label for="reg_microempresa" class="col-sm-12 col-form-label"
        ...
        <div class="form-group row">
          <div class="col-sm-4">
            <label for="age_retencion" class="col-sm-12 col-form-label"
              >Age. Retención:</label
            >
          ...
          <div class="col-sm-4">
            <label for="tip_ambiente" class="col-sm-12 col-form-label"
              >Tipo Ambiente:</label
            >
          ...
          <div class="col-sm-4">
            <label for="tip_emision" class="col-sm-12 col-form-label"
              >Tipo Emisión:</label
            >
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-4">
            ...
            >
            <input type="password" class="form-control" v-model="fir_clave" />
          </div>
          <div class="col-sm-4">
            <label for="fir_vencimiento" class="col-sm-12 col-form-label"
              >Fec. Vencimiento:</label
            >
            <input type="date" class="form-control" v-model="fir_vencimiento" />
          </div>
        </div>
        <hr />
        <div class="form-group row">
        ...
        <div class="form-group row">
          <label for="corr_autenticacion" class="col-sm-4 col-form-label"
