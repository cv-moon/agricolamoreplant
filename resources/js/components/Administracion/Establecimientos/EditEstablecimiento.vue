  ...
  <div class="card card-primary card-outline">
    <div class="card-header">
      <h3 class="card-title mt-2">
        ...
        Editar Establecimiento: {{ `${nom_comercial} - ${nom_referencia}` }}
      </h3>
      <div class="card-tools">
        <router-link to="/establecimientos" class="btn btn-secondary btn-sm">
    ...
    <div class="card-body">
      <form>
        ...
        <div class="form-group row">
          <label for="numero" class="col-sm-2 col-form-label">No.:</label>
          <div class="col-sm-2">
            <input
              type="number"
              class="form-control"
