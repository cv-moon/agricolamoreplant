  ...
  <div class="card card-primary card-outline">
    <div class="card-header">
      ...
      <div class="card-tools">
        <router-link to="/establecimientos/agregar" class="btn btn-success">
      ...
      >
        ...
        <tbody>
          <tr
            ...
            :class="
              establecimiento.estado == 1 ? 'table-success' : 'table-danger'
            "
          >
            <td>
              <router-link
                type="button"
                title="Editar"
                :to="'/establecimientos/editar/' + establecimiento.id"
