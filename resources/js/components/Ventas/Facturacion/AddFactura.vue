                ...
                <div class="col-5">
                  ...
                  "
                            ...
                            <div class="form-group row">
                                ...
                                <div
                                    class="col-sm-6 bg-lightblue disabled color-palette text-right"
                                >
                                    $
                                    {{
                        ...
                        >
                            ...
                            <tbody>
                                ...
                                >
                                    ...
                                    <td
                                        align="right"
                                        v-text="producto.pre_venta"
                                    ></td>
                                    <td
                                        align="right"
                                        v-text="producto.valor + ' %'"
                                    ></td>
                                    <td
                                        align="right"
                                        v-text="producto.por_descuento + ' %'"
                                    ></td>
                                    <td
                                        align="right"
