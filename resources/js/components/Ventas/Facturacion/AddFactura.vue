    ...
    <div class="card-body">
      ...
      <div class="form-group row">
        ...
        <div class="col-3">
          ...
          >
          <h3 class="text-success">${{ info.dis_facturar.toFixed(2) }}</h3>
        </div>
      </div>
    ...
    getId() {
      if (!this.selected) {
        ...
        axios
          ...
          .then((resp) => {
            this.info.sal_pendiente = parseFloat(resp.data.saldos).toFixed(2);
            this.info.dis_facturar =
              parseFloat(resp.data.limite["lim_credito"]).toFixed(2) -
