                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6 bg-lightblue text-right">
                                    $
                                    {{
                                        (factura.sub_iva = subtotalIva.toFixed(
                                            2
                                        ))
                                    }}
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6 bg-lightblue text-right">
                                    $
                                    {{
                                        (factura.sub_0 = subtotalCero.toFixed(
                                            2
                                        ))
                                    }}
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6 bg-lightblue text-right">
                                    $
                                    {{
                                        (factura.sub_no_iva = subtotalNoObjeto.toFixed(
                                            2
                                        ))
                                    }}
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6 bg-lightblue text-right">
                                    $
                                    {{
                                        (factura.sub_exento = subtotalExento.toFixed(
                                            2
                                        ))
                                    }}
                                </div>
                  ...
                  "
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6 bg-lightblue text-right">
                                    $
                                    {{
                                        (factura.val_iva = calcularIva.toFixed(
                                            2
                                        ))
                                    }}
                                </div>
                    ...
                    <div class="modal-body">
                        <form>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <select
                                        v-model="cliente.identificacion_id"
                                        class="form-control"
                                    >
                                        <option value="0" disabled
                                            >Seleccione...</option
                                ...
                                <div class="col-sm-4">
                                    <template
                                        v-if="cliente.identificacion_id === 2"
                                    >
                                        <input
                                            type="text"
                                            class="form-control"
                            ...
                            <div
                                v-if="cliente.errors.length"
                                class="alert alert-danger"
                            >
                                <div>
                                    <div
                                        v-for="error in cliente.errors"
                                        :key="error"
                                    >
                                        {{ error }}
                                    </div>
...
export default {
    ...
    methods: {
        ...
        getInfo(data = null) {
            ...
            this.detalle.dis_stock = data.dis_stock;
            this.detalle.precio = data.pre_venta;
            this.detalle.descuento = data.por_descuento;
        },
        addDetalle(data = []) {
            console.log(data);
            ...
            if (resp) {
                ...
                this.arrayDetalle.push({
                    ...
                    fec_vencimiento: "",
                    pre_venta: data.precio,
                    por_descuento: data.descuento,
                    codigo: data.presentacion.codigo,
                    valor: data.presentacion.valor,
