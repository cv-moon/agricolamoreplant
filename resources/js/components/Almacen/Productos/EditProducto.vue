<template>
  <div class="card card-primary card-outline">
    ...
    <div class="card-body">
      ...
      <div class="form-group row">
        <div class="col-md-3">
          <label for="pre_venta" class="col-form-label">Precio Compra:</label>
          <input
            type="number"
            class="form-control"
            placeholder="0.000"
        ...
        <div class="col-md-3">
          <label for="tar_agregado_id" class="col-form-label">Impuesto:</label>
        ...
        <table class="table table-bordered table-striped table-sm">
          <thead>
            <tr>
              ...
              <th class="text-center">Cod. Principal</th>
              <th class="text-center">Cod. Auxiliar</th>
          ...
          <tbody>
            ...
            >
              <td align="center">
                <button
                  @click="eliminarPresentacion(presentacion.id)"
            ...
            <tr align="center">
              <td colspan="5">
                <button class="btn btn-success btn-xs" @click="addPresentacion">
  ...
  methods: {
    ...
    getCodigo() {
      for (let i = 0; i < this.arrayPresentaciones.length; i++) {
        let cat = this.arrayCategorias.find((e) => e.id === this.categoria_id);
        let uni = this.arrayUnidades.find(
          (e) => e.id === this.arrayPresentaciones[i].unidad_id
        );
        this.arrayPresentaciones[i].cod_principal = this.arrayPresentaciones[
          i
        ].cod_auxiliar =
