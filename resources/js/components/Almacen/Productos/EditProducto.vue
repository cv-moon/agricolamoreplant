  ...
  <div class="card card-primary card-outline">
    ...
    <div class="card-body">
      ...
      <div class="form-group row">
        <div class="col-sm-4">
          <label for="categoria_id" class="col-sm-12 col-form-label"
            >Categoría:</label
          >
          <select
      ...
      <div class="form-group row">
        <div class="col-sm-12">
          <label for="composicion" class="col-sm-12 col-form-label"
            >Composición:</label
          >
          <input
            type="text"
      ...
      <div class="form-group row">
        <div class="col-sm-4">
          <label for="cod_principal" class="col-sm-12 col-form-label"
            >Cod. Principal:</label
          >
          <input
            type="text"
        ...
        <div class="col-sm-4">
          <label for="cod_auxiliar" class="col-sm-12 col-form-label"
            >Cod. Auxiliar:</label
          >
          <input
            type="text"
      ...
      <div class="form-group row">
        <div class="col-md-4">
          <label for="pre_venta" class="col-sm-12 col-form-label">P.V.P:</label>
          <input
            type="number"
            class="form-control"
            placeholder="0.000"
        ...
        <div class="col-md-4">
          <label for="por_descuento" class="col-sm-12 col-form-label"
            >Descuento (%):</label
          >
          <input
            type="number"
        ...
        <div class="col-md-4">
          <label for="tarifa_id" class="col-sm-12 col-form-label"
            >Impuesto:</label
          >
