  ...
  <div class="card card-primary card-outline">
    ...
    <div class="card-body">
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-6">
          <label for="establecimiento" class="col-sm-12 col-form-label"
      ...
      <div class="form-group row">
        ...
        >
        <div class="col-sm-4">
          <input type="date" class="form-control" v-model="fec_emision" />
        </div>
      </div>
          ...
          <table class="table table-bordered table-striped table-sm">
            <thead>
              <tr>
                ...
                <th class="text-center" style="width: 15%">Fec. Cad.</th>
            ...
            <tbody v-if="arrayDetalle.length">
              ...
              <tr style="background-color: #ceecf5">
                ...
                <td align="right">
                  $ {{ (sub_0 = calcularSubTotalCero.toFixed(2)) }}
                </td>
              </tr>
              <tr style="background-color: #ceecf5">
                <td colspan="6" align="right">
                ...
                <td align="right">
                  $ {{ (tot_desc = calcularDescuento.toFixed(2)) }}
                </td>
              </tr>
              <tr style="background-color: #ceecf5">
                <td colspan="6" align="right">
                ...
                <td align="right">
                  $ {{ (sub_12 = calcularSubTotalDoce.toFixed(2)) }}
                </td>
              </tr>
              <tr style="background-color: #ceecf5">
                <td colspan="6" align="right">
      ...
      <div class="form-group row">
        <div class="col-sm-3">
          <label for="for_pago" class="col-form-label">Forma de Pago:</label>
          <select v-model="for_pago" class="form-control" @change="valSaldo()">
            <option value="0" disabled>Seleccione...</option>
        ...
        <template v-if="for_pago == 'C'">
          <div class="col-sm-3">
            <label for="saldo" class="col-form-label">Valor de Crédito:</label>
            <input
              type="number"
              class="form-control"
              v-model="saldo"
          ...
          <div class="col-sm-3">
            <label for="fec_limite" class="col-form-label"
              >Fecha a Pagar:</label
            >
            <input type="date" class="form-control" v-model="fec_limite" />
          </div>
          <div class="col-sm-12">
    ...
    <div class="modal-footer">
      <router-link to="/compras" class="btn btn-danger"> Cancelar </router-link>
    ...
    <!-- /.modal -->
    <!-- Start Proveedor Modal -->
    <div class="modal fade" id="modProv">
      <div class="modal-dialog modal-xl">
        <div class="modal-content">
          <div class="modal-header">
...
export default {
  ...
  methods: {
    ...
    productos() {
      axios
        .get(
          "/api/productos/establecimiento?establecimiento=" +
    ...
    agregar(data = []) {
      if (this.encuentra(data["id"])) {
        Swal.fire("Error!", "El producto ya se encuentra agregado.", "error");
      } else {
    ...
    validaCamposProv() {
      this.errorsProv = [];
      if (!this.nombre) {
        this.errorsProv.push("Ingrese nombre.");
      }
      if (this.tip_identificacion == "0") {
        this.errorsProv.push("Seleccione tipo de identificación.");
      }
      if (!this.num_identificacion) {
        this.errorsProv.push("Ingrese número de identificación.");
      }
      return this.errorsProv;
    },
    guardarProveedor() {
      const condiciones = this.validaCamposProv();
      if (condiciones.length) {
        return;
      }
      axios
