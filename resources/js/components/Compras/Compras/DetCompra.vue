          ...
          <table class="table table-bordered table-striped table-sm">
            ...
            <tbody v-if="arrayDetalle.length">
              <tr v-for="detalle in arrayDetalle" :key="detalle.id">
                ...
                <td align="right" v-text="detalle.descuento"></td>
                <td align="right">
                  $
                  {{
                    (
    ...
    detalle() {
      axios
        ...
        .then((resp) => {
          ...
          this.tip_comprobante = resp.data.comprobante["tip_comprobante"];
          this.num_comprobante = resp.data.comprobante["num_comprobante"];
