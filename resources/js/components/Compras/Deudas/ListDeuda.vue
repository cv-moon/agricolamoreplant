                ...
                <div class="col-sm-4">
                    <select v-model="proveedor" class="form-control">
                        ...
                        <option
                            ...
                            :key="proveedor.id"
                            :value="proveedor.id"
                            v-text="proveedor.raz_social"
                        ></option>
                    </select>
                </div>
                <label for="estado" class="col-sm-1 col-form-label"
                    >Estado:</label
                >
                <div class="col-sm-2">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            >
                                            <h5
                                                class="col-sm-6 text-right text-orange"
                                            >
                                                {{ saldo.toFixed(2) }}
                                            </h5>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            >
                                            <h5
                                                class="col-sm-6 text-right text-green"
                                            >
                                                {{ val_abono }}
                                            </h5>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            >
                                            <h5
                                                class="col-sm-6 text-right text-red"
                                            >
